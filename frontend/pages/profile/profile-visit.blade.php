                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                               ...
                               <span class="info-box-number"> <strong>{{ $countFaq  }}</strong> câu</span>
                            </div>
                         </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                               <span class="info-box-text"> Số câu trả lời</span>
                               <span class="info-box-number"> <strong>{{ $countFaqAnswer  }}</strong> câu</span>
                            </div>
                         </div>
                    </div>
