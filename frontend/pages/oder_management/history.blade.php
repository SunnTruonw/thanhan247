...
@section('content')
    <div class="card mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-9 ">
                    <h6 class="titlequanly">Lịch sử giao dịch</h6>
                    <div class="wrap-btn-total">
                        <div class="btn-total total-root bg-danger">
                            <a class="text-decoration-none ">
                                Tổng: {{number_format($totalRoot)}} đ
                            </a>
                        </div>
    
                        <div class="btn-total total-payed bg-success">
                            <a class="text-decoration-none ">
                                Đã thanh toán: {{number_format($totalThanhToan)}} đ
                            </a>
                        </div>
    
                        <div class="btn-total total-no bg-primary">
                            <a class="text-decoration-none">
                                Còn nợ: {{number_format($totalRoot - $totalThanhToan)}} đ
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="dataTable_filter" class="text-start">
                        <form action="{{ route('order_management.index') }}" method="GET" id="form-search">
                            <div class="row mb-3">
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-0" style="min-width:100px;">
            ...
            <div class="table-responsive">
                <table id="dataTable" width="100%" cellspacing="0" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>STT</th>
                            <th class="text-nowrap">Ngày giờ</th>
