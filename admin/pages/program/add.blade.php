...
<div class="content-wrapper">
    @include('admin.partials.content-header',['name'=>"Chương trình","key"=>"Thêm chương trình"])
    <!-- Main content -->
    <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form class="form-horizontal" action="{{route('admin.program.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                                ...
                                                <div id="tong_quan" class="container tab-pane active "><br>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="tong_quan_{{$langItem['value']}}" class="container wrapChangeSlug tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <label class="col-sm-2 control-label" for="">Nhập nội dung soạn bài</label>
                                                                    <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-2 control-label" for="">Thời gian làm bài</label>
                                                            <div class="col-sm-10">
                                                                <input type="number" min="0" class="form-control  @error('time') is-invalid  @enderror"  value="{{ old('time') }}" name="time" placeholder="Nhập thời gian làm bài trắc nghiệm">
                                                            </div>
                                                            @error('time')
                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                                            @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="card card-outline card-primary">
                                        <div class="card-header">
                                        <h3 class="card-title w-100">Thêm đoạn văn   <a data-url="{{ route('admin.program.loadParagraphProgram') }}" class="btn  btn-info btn-md float-right " id="addParagraph">+ Thêm đoạn văn</a></h3>
                                        </div>
                                        <div class="card-body table-responsive p-3">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <select class="form-control" id="" value="" name="typeParagraph[]" required>
                                                                                            ...
                                                                                            @foreach (config('paragraph.programs') as $keyC=> $valueC)
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <select class="form-control" id="" value="" name="typeParagraph[]" required>
                                                                                        ...
                                                                                        @foreach (config('paragraph.programs') as $key=> $value)
