...
@section('title',"danh sach category product")
@section('css')
<style>
            ...
            <div class="col-md-12">
                ...
                <ol class="breadcrumb">
                  ...
                  @foreach ($parentBr->breadcrumb as $item)
                   <li><a href="{{ route('admin.categoryproduct.index',['parent_id'=>$item['id']]) }}">{{ $item['nameL'] }}</a></li>
                  @endforeach
                  <li><a href="{{ route('admin.categoryproduct.index',['parent_id'=>$parentBr->id]) }}">{{ $parentBr->nameL }}</a></li>
                </ol>
                @endif
