...
@section('title',"Thêm exam")
@section('css')
@endsection
@section('content')
<div class="content-wrapper">
    @include('admin.partials.content-header',['name'=>"exam","key"=>"Thêm exam"])
    <!-- Main content -->
    <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form class="form-horizontal" action="{{route('admin.exam.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card card-outline card-primary">
                                                <div class="card-header mb-3">
                                                    <h3 class="card-title">Thông tin exam</h3>
                                                </div>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div id="tong_quan_{{$langItem['value']}}" class="container wrapChangeSlug tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <label class="col-sm-2 control-label" for="">Tên exam</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control nameChangeSlug
                                                                            @error('name_'.$langItem['value']) is-invalid @enderror" id="name_{{$langItem['value']}}" value="{{ old('name_'.$langItem['value']) }}" name="name_{{$langItem['value']}}" placeholder="Nhập tên exam">                                            @error('name_'.$langItem['value'])
                                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control custom-select select-2-init @error('category_id')
                                                            ...
                                                            @if (old('category_id'))
                                                                {!! \App\Models\CategoryExam::getHtmlOption(old('category_id')) !!}
                                                            @else
                                                            {!!$option!!}
                                                            @endif
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label" for="">Thời gian làm bài (phút)</label>
                                                        <input type="number" min="0" class="form-control  @error('time') is-invalid  @enderror" value="{{ old('order') }}" name="time" placeholder="Nhập thời gian làm bài">
                                                        @error('time')
                                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                                        @enderror
                                                    </div>
