...
<div class="content-wrapper lb_template_post_edit">
    @include('admin.partials.content-header',['name'=>"Exam","key"=>"Sửa Exam"])
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{route('admin.exam.update',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="card-header">
                                     ...
                                     <div class="card-body table-responsive">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control  @error('time') is-invalid  @enderror"  value="{{ old('time')??$data->time }}" name="time" placeholder="Nhập thời gian làm bài">
                                            @error('time')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
