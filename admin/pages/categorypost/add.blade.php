                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" action="{{ route('admin.categorypost.store') }}" method="POST"
                                                        ...
                                                        @foreach ($langConfig as $langItem)
                                                            <div id="tong_quan_{{ $langItem['value'] }}"
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <label class="col-sm-2 control-label" for="">Tên
                                                                            danh mục</label>
                                                                        <div class="col-sm-10">
                                                                            <input type="text"
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea
                                                                                class="form-control  @error('description_' . $langItem['value']) is-invalid @enderror"
                                                                                name="description_{{ $langItem['value'] }}"
                                                                                id="" rows="3"
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea
                                                                                class="form-control tinymce_editor_init @error('content_' . $langItem['value']) is-invalid  @enderror"
                                                                                name="content_{{ $langItem['value'] }}"
                                                                                id="" rows="20" value=""
                                                                ...
                                                                <div class="form-check-inline">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input"
                                                                            value="1" name="active" @if (old('active') === '1' || old('active') === null) {{ 'checked' }} @endif>Hiện
                                                                    </label>
                                                                </div>
                                                                <div class="form-check-inline">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input"
                                                                            value="0" @if (old('active') === '0') {{ 'checked' }} @endif name="active">Ẩn
                                                                    </label>
                                                                </div>
                                                                @error('active')
                                                                    <div class="invalid-feedback d-block">{{ $message }}
                            ...
                            <div class="col-md-12">
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title w-100">Thêm Banner <a
                                                data-url="{{ route('admin.categorypost.loadParagraphCategoryPost') }}"
                                                class="btn  btn-info btn-md float-right " id="addParagraph">+ Thêm đoạn
                                                văn</a></h3>
                                    </div>
                                    <div class="card-body table-responsive p-3">
                                        <div class="wrap-paragraph">
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th style="width:calc(100% - 50px);">Nhập thông tin banner</th>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-10">
                                                                                                    <textarea
                                                                                                        ...
                                                                                                        name="valueParagraph_{{ $langItem['value'] }}[]"
                                                                                                        id="" rows="15"
                                                                                                        value=""
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <select class="form-control" id=""
                                                                                            value="" name="typeParagraph[]"
                                                                                            required>
                                                                                            <option value="">--- Chọn kiểu
                                                                                                đoạn ---</option>
                                                                                            @foreach (config('paragraph.category_posts') as $keyC => $valueC)
                                                                                                <option
                                                                                                    value="{{ $keyC }}"
