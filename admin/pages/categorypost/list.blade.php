            ...
            <div class="col-md-12">
                ...
                <ol class="breadcrumb">
                  ...
                  @foreach ($parentBr->breadcrumb as $item)
                   <li><a href="{{ route('admin.categorypost.index',['parent_id'=>$item['id']]) }}">{{ $item['nameL'] }}</a></li>
                  @endforeach
                  <li><a href="{{ route('admin.categorypost.index',['parent_id'=>$parentBr->id]) }}">{{ $parentBr->nameL }}</a></li>
                </ol>
                @endif
