                    ...
                    <form class="form-horizontal" action="{{route('admin.categorypost.update',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    @error('name_'.$langItem['value']) is-invalid @enderror" id="name_{{$langItem['value']}}" value="{{ old('name_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->name }}" name="name_{{$langItem['value']}}" placeholder="Nhập tên danh mục">
                            ...
                            <div class="col-md-8">
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                    <h3 class="card-title w-100">Banner đã thêm <a data-url="{{ route('admin.categorypost.loadCreateParagraphCategoryPost',['id'=>$data->id]) }}" class="btn  btn-info btn-md float-right " id="addParagraphAjax">+ Thêm đoạn văn</a></h3>
                                    </div>
                                    <div class="card-body table-responsive p-3">
                                        <div id="loadListParagraph">
                                            @include('admin.components.paragraph.load-list-paragraph',[
                                                'type'=>config('paragraph.category_posts'),
                                                'data'=>$data,
