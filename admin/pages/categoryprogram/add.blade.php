...
@section('title',"Thêm danh mục chương trình")
@section('content')


<div class="content-wrapper">
    @include('admin.partials.content-header',['name'=>"Category program","key"=>"Thêm danh mục chương trình"])
    <!-- Main content -->
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{route('admin.categoryprogram.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
