        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{route('admin.categoryprogram.update',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <select class="form-control custom-select select-2-init @error('parent_id')
                                                                ...
                                                                {!! \App\Models\CategoryProgram::getHtmlOptionAddWithParent(old('parent_id')) !!}
                                                                @else
                                                                {!!$option!!}
                                                                @endif
                                                            </select>
