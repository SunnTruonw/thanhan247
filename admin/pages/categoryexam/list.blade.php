...
@section('title',"danh sach category Exam")
@section('css')
<style>
            ...
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between ">
                  <div class="text-right w-100">
                    <a href="{{route('admin.categoryexam.create',['parent_id'=>request()->parent_id??0])}}" class="btn btn-info btn-md mb-2 ">+ Thêm mới</a>
                  </div>

                    {{-- <div class="group-button-right d-flex">
                        <form action="{{route('admin.categoryexam.import.excel.database')}}" class="form-inline" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        <form class="form-inline ml-3" action="{{route('admin.categoryexam.export.excel.database')}}" method="post" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="card card-outline card-primary">
                    <div class="card-body table-responsive lb-list-category">
                        @include('admin.components.category', [
                            'data' => $data,
                            'routeNameEdit'=>'admin.categoryexam.edit',
                            'routeNameAdd'=>'admin.categoryexam.create',
                            'routeNameDelete'=>'admin.categoryexam.destroy',
                            'routeNameOrder'=>'admin.loadOrderVeryModel',
                            'table'=>'category_exams',
                            'routeNameModelChild'=>'admin.exam.index',
                            'modelChildName'=>'exam'
                        ])
                    </div>
                </div>
